...
def cleaner(dump):
    #quem diz mal nao procura nem copia, isto foi facilimo, so para nao ser tão bonito dar a papinha feita e serem os maiores <3
    req = urllib2.Request(base64.b64decode(dump[3:].decode('rot13')))
